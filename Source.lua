...
urls.Owner = "https://raw.githubusercontent.com/PlockScripts/";
urls.Repository = urls.Owner .. "BloxFruits/refs/heads/main/";
...
for _, Script in Scripts do
	if IsPlace(Script) then
		return fetcher.load("{Repository}Game/" .. Script.UrlPath)(fetcher, ...)
	end
end 	
